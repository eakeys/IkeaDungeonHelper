...
local function doHPCalcs()
    -- Third one is not really needed
    local currentTargetHP, maxTargetHP, effmaxTargetHP = GetUnitPower("boss1", POWERTYPE_HEALTH)
end

local function doPositionCalcs()
...
IDH_blah1.Load = function()
    d("[IDH] Loaded module for dungeon 1.")
...
IDH_blah2.Load = function() end

IDH_blah1.BeginUnload = function()
    d("[IDH] Unloaded module for Black Gem Foundry.")
end

IDH_Debug = {}

IDH_Debug.Load = function()
